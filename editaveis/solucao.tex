...
\begin{figure}[H]
	\centering
    \includegraphics[width=0.7\textwidth]{figuras/cartao}
...
A imagem da tela do monitor serial (UART) do Arduino pode ser mostrada na figura \ref{fig:serial_bancada}
